...
<%@ Register Assembly="DevExpress.Web.v13.1, Version=13.1.12.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web.ASPxGridView"
    TagPrefix="dx" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel" runat="server">
            <ContentTemplate>
                <dx:ASPxGridView ID="grid" ClientInstanceName="grid" runat="server" EnableCallBacks="false" DataSourceID="AccessDataSource1"
                    KeyFieldName="EmployeeID" AutoGenerateColumns="False" Width="50%" OnRowUpdating="grid_RowUpdating" 
                    OnRowInserting="grid_RowInserting" OnParseValue="grid_ParseValue" OnRowValidating="grid_RowValidating">
                    <%-- BeginRegion Columns --%>
                    <Columns>
